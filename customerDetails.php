...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="customerDetails.php">Detailed on Customers</a>
  <a class="w3-bar-item w3-button w3-hover-black" href="AllRoutes.php">Routes</a>
</nav>
...
<h2 align="center">All Customers Details</h2>
  <tr>
    <th>No</th>
    <th>Full name</th>
    <th>Phone number</th>
...
<h3 align="center"><button><a href="generateAllCustomers-pdf.php">download pdf</a></button></h3>
</p>
    </div>
  ...
  <footer id="myFooter">
    ...
    <div class="w3-container w3-theme-l1">
      <p>Powered <a href="default.html" target="_blank">Group 2</a></p>
    </div>
  </footer>
